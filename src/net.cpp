...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("XCloudcoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "XCloudcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"188.226.138.101", "188.226.138.101"},
    	{"178.62.54.233", "178.62.54.233"},
    	{"192.241.220.55", "192.241.220.55"},
    	{"80.240.138.12", "80.240.138.12"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("XCloudcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("XCloudcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("XCloudcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("XCloudcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. XCloudcoin is probably already running."), addrBind.ToString().c_str());
        else
